...
| **S1 – New model types** | Baseline + new models | The new m odels are (PV, BEMS, Battery ) Test the capability to integrate additional heterogeneous model types into the co-simulation. | yes |
